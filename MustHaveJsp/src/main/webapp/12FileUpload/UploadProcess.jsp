...
<%
	...
	try {
		...
		//4. 다른 폼값 받기
		String name = mr.getParameter("name"); //post로 넘어온 name값을 name변수에 넣는다
		String title = mr.getParameter("title");
		String[] cateArray = mr.getParameterValues("cate"); //checkBox의 값을 배열로 받아옴 
		...
		dto.setSfile(newFileName); //폼으로 입력 받은 내용을 변환하여 객체 생성
